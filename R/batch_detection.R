# dec 8 2021: https://rdrr.io/github/EvaYiwenWang/PLSDAbatch/src/R/batch_detection.R
##########################################################################
...
Scatter_Density <- function(object,
  ...
  expl.var = object[['prop_expl_var']]$X # changed from object[['explained_variance']] on dec 20 2021
