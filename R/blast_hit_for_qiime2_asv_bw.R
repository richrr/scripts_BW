...
#usage:
#module load blast
#Rscript /data/rodriguesrr/scripts/R/blast_hit_for_qiime2_asv_bw.R /data/rodriguesrr/db/amiran_mothur_format/ncbi20.fasta.ncbi.format.fa /data/rodriguesrr/db/amiran_mothur_format/ncbi20.tax ../sequences.fasta qiime2.asv.txt
