        		...
        		if( (grepl(";", c1))&(grepl(";", c2)) ) {
			      ...
			      # add the base statistics and the t test results
						for (contarst in 1:length(comparisonsargs)){
						    ...
						    out2 = t(out2)
						    colnames(out2) = c(paste("Analys", indxg_, comparMethod,"Mean", c1_, sep=" "), paste("Analys", indxg_, comparMethod,"Mean", c2_, sep=" "), paste("Analys", indxg_, comparMethod,"FoldChange", c1_,"_vs_",c2_, sep=" "), paste("Analys", indxg_, comparMethod,"Median", c1_, sep=" "), paste("Analys", indxg_, comparMethod,"Median", c2_, sep=" "), paste("Analys", indxg_, comparMethod,"FolChMedian", c1_,"_vs_",c2_, sep=" "), paste("Analys", indxg_, comparMethod,"GeoMean", c1_, sep=" "), paste("Analys", indxg_, comparMethod,"GeoMean", c2_, sep=" "), paste("Analys", indxg_, comparMethod,"FolChGeoMean",  c1_,"_vs_",c2_, sep=" "))
						    #print(head(out2))
					    ...
					    colnames(out1) = c(paste("Analys", indxg, comparMethod,c1,"_vs_",c2,"limmaslog2FC=meanA-meanB",sep=" "), paste("Analys", indxg, comparMethod, c1,"_vs_",c2,"limma t",sep=" "), paste("Analys", indxg, comparMethod,c1,"_vs_",c2,"pvalue",sep=" "), paste("Analys", indxg, comparMethod,c1,"_vs_",c2,"FDR",sep=" "), paste("Analys", indxg, comparMethod,c1,"_vs_",c2,"log_odds_deg",sep=" "))
					    #print(head(out1))

					    out2 = sapply(lgenes, GetSimpleStats, subsetexpressionData, c1, c2, dict)
					    out2 = t(out2)

					    colnames(out2) = c(paste("Analys", indxg, comparMethod,"Mean", c1, sep=" "), paste("Analys", indxg, comparMethod,"Mean", c2, sep=" "), paste("Analys", indxg, comparMethod,"FoldChange",  c1, "_vs_", c2, sep=" "), paste("Analys", indxg, comparMethod,"Median", c1, sep=" "), paste("Analys", indxg, comparMethod,"Median", c2, sep=" "), paste("Analys", indxg, comparMethod,"FolChMedian", c1, "_vs_", c2, sep=" "), paste("Analys", indxg, comparMethod,"GeoMean", c1, sep=" "), paste("Analys", indxg, comparMethod,"GeoMean", c2, sep=" "), paste("Analys", indxg, comparMethod,"FolChGeoMean",  c1, "_vs_", c2, sep=" "))
					    #print(head(out2))
...
calculateComparisCorrelation = function (pairs, expressionData, c1, c2, dict, correlMethod, pairedd, indxg){
		...
		colnames(out) = c( paste("Analys", indxg, c1, method_label,"Coefficient",sep=" "), paste("Analys", indxg, c1, method_label, "CategCorPVal",sep=" "),
				   ...
				   paste("Analys", indxg, method_label,c1,"_vs_",c2,"DiffCorrs",sep=" "),
				       paste("Analys", indxg, method_label,c1,"_vs_",c2,"pvalue",sep=" "))
...
calculateComparisDeltaCorrelation = function (pairs, expressionData, c1, c2, c3, c4, dict, correlMethod, indxg){
		...
		colnames(out) = c(paste("Analys", indxg, c1, "minus" , c2, method_label,"Coefficient",sep=" "), paste("Analys", indxg, c1, "minus" , c2, method_label, "CategCorPVal",sep=" "),
				  ...
				  paste("Analys", indxg, method_label, c1, "minus" , c2, "_vs_", c3, "minus" , c4, "DiffCorrs",sep=" "),
				      paste("Analys", indxg, method_label, c1, "minus" , c2, "_vs_", c3, "minus" , c4, "pvalue",sep=" "))

		# calculate FDR
		FDR = p.adjust(out[,colnames(out)[grep("pvalue",colnames(out))]],method="fdr")
		oldColnames = colnames(out)
		out = cbind(out, FDR)
		colnames(out) = c(oldColnames,paste("Analys", indxg, method_label,c1, "minus" , c2, "_vs_", c3, "minus" , c4,"FDR",sep=" "))
		pairName = rownames(out)
		out = cbind(pairName,out)
		out
}
