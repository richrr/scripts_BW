...
# Usage: Rscript /data/rodriguesrr/scripts/R/merge-calc-freq-result-files_bw.R --files network_spearm-manwhit_expt1_comp-output.csv network_spearm-manwhit_expt2_comp-output.csv --parallel --output merged_two_expts_sp_mw_files_comp_all_
...
# parameters
#==================================================================================================================
p <- arg_parser('Calculate which gene show consistency freq across experiments for same comparison analysis')
